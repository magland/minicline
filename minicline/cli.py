...
def perform_task_cmd(instructions: str | None, file: Path | None, model: str | None, vision_model: str | None, log_file: Path | None, auto: bool, approve_all_commands: bool):
    ...
    perform_task(instructions, model=model, vision_model=vision_model, log_file=log_file, auto=auto, approve_all_commands=approve_all_commands)
